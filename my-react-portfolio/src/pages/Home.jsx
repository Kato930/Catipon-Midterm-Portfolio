      ...
      <article id="main" className="col-span-1 md:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 transition-colors">
        ...
        <section className="mb-8">
          ...
          <p className="mb-6 text-gray-700 dark:text-gray-300 leading-relaxed">
            Welcome to my portfolio! This website contains <strong className="font-bold text-blue-600 dark:text-blue-400">information about my background</strong> and my technical <mark className="bg-yellow-200 dark:bg-yellow-800 dark:text-white rounded px-1">Projects.</mark>
          </p>
